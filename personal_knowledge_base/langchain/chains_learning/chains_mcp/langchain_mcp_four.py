...
from langchain_core.output_parsers import JsonOutputKeyToolsParser # 导入标准输出组件
...
model = ChatOpenAI(
    ...
    api_key="sk-ytfpfqvhoudkcrourmflbtsrknaylwguspsajdkzzzbcwjpc", #你注册的硅基流动api_key
)
